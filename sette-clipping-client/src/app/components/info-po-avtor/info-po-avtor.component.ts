...
import { ChartsModelAutorService } from 'src/app/services/charts/charts-model-author.service';
...
export class InfoPoAvtorComponent {
  public chartModelAuthorList: ChartsModelAuthor[];
  ...
  private chartsModelAuthorService: ChartsModelAutorService) {
    this.charta=new ChartsModelAuthor();
   }

   ngOnInit(): void {
    this.returnClipsByAuthor();
  }


  public returnClipsByAuthor(): void {
    console.log('in returnClipsByAuthor');
    this.chartsModelAuthorService.return_clips_by_author().subscribe(
      (response: ChartsModelAuthor[]) => {
        ...
        console.log(this.chartModelAuthorList);
      },
